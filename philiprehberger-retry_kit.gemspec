...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = 'https://philiprehberger.com/open-source-packages/ruby/philiprehberger-retry_kit'
  spec.license = 'MIT'

  spec.required_ruby_version = '>= 3.1.0'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri']       = 'https://github.com/philiprehberger/rb-retry-kit'
  spec.metadata['changelog_uri']         = 'https://github.com/philiprehberger/rb-retry-kit/blob/main/CHANGELOG.md'
  spec.metadata['bug_tracker_uri']       = 'https://github.com/philiprehberger/rb-retry-kit/issues'
